...
document.body.append(SecondModal)
const SecondModalInner = document.createElement('div')
SecondModal.append(SecondModalInner)

function MakeModal(){
    SecondModal.style.position = 'fixed'
    SecondModal.style.top ='0'
    SecondModal.style.left ='0'
    SecondModal.style.zIndex = '1055'
    SecondModal.style.display ='block'
    SecondModal.style.width = '100vw'
    SecondModal.style.height='100vh'
    SecondModal.style.overflow ='hidden'
    SecondModal.style.backgroundColor = 'rgba(0, 0, 0, 0.5)'

    // modalInner
    SecondModalInner.style.margin = '40px auto'
    SecondModalInner.style.width = '500px'
    SecondModalInner.style.height= '100px'
    SecondModalInner.style.background ='white'
    SecondModalInner.style.fontSize = '50px'
    SecondModalInner.style.fontWeight ='600'
    SecondModal.style.textAlign = 'center'
    
}

SecondModalInner.innerText = 'Success'
...
function newPost(){
    ...
    MakeModal()
    SecondModalInner.innerText ='loading...'
    closinModal()
    fetch('server.php',{
        method: 'POST',
        headers: {'Content-type':'application/json'},
       ...
       if(res.ok ===true){
        ...
        SecondModalInner.innerText = 'fail'
    }).finally(()=>{
        setTimeout(()=>{
